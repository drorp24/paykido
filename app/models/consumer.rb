...
#                      :message => "--- you can only upload pictures"
  ...
  def self.payer_consumers_the_works(payer_id)
    ...
    self.find_all_by_payer_id(payer_id,
               :group => ("consumers.id, name, balance, billing_phone, pin, pic, payer_rules.id as payer_rule_id, allowance, rollover, auto_authorize_under, auto_deny_over, authorized"),
